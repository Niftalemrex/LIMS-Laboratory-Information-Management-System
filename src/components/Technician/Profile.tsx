...
const Profile: React.FC<ProfileProps> = ({ userMenuProfile, setUserMenuProfile }) => {
  ...
  // Sync editData and avatarPreview if userMenuProfile changes in parent
  useEffect(() => {
        ...
        <div className="profile-card">
          <div className="profile-avatar-section">
            <div className="avatar-container">
              ...
              {isEditing && (
                <>
                  <button className="avatar-edit-btn" onClick={triggerFileInput} aria-label="Change profile picture">
                    {/* SVG icon */}
